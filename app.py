...
def load_data():
    ...
    data = {
        ...
        'keywords': [
            ...
            'alien pandora 3d', 'virtual-reality hacker simulation', 'marvel superhero inventor', 'love memory alzheimers', 'rome gladiator revenge',
...
def recommend(movie_title, df, similarity_matrix):
    """
    Finds the top 5 most similar movies based on the cosine similarity matrix.
    """
    ...
    # Retrieve the actual movie data for the top 5 recommendations
